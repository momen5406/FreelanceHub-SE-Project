  ...
  <div class="container hero-content text-center">
    <div class="row justify-content-center">
      <div class="col-lg-9">
        ...
        <p class="lead text-white-50 mb-5 px-md-5">FreelanceHub connects visionary clients with elite professionals. Secure escrow payments, seamless collaboration, and world-class results.</p>
