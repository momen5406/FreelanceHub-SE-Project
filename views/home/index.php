...
<div class="container py-5 mt-4 mb-5">
    <div class="text-center mb-5">
        <h2 style="color: #1a1a2e; font-weight: 800; letter-spacing: -0.5px;">Browse Top Categories</h2>
        <p class="text-muted">Find exactly what you need to make your project a success.</p>
    </div>

    <div class="row g-4">
        <div class="col-md-6 col-lg-3">
            <a href="/jobs?category=web" class="category-card">
        ...
        <div class="col-md-6 col-lg-3">
            <a href="/jobs?category=mobile" class="category-card">
                <div class="category-icon" style="background: rgba(46, 204, 113, 0.15); color: #27ae60;"><i
        ...
        <div class="col-md-6 col-lg-3">
            <a href="/jobs?category=design" class="category-card">
                <div class="category-icon" style="background: rgba(155, 89, 182, 0.15); color: #8e44ad;"><i
        ...
        <div class="col-md-6 col-lg-3">
            <a href="/jobs?category=writing" class="category-card">
                <div class="category-icon" style="background: rgba(52, 152, 219, 0.15); color: #2980b9;"><i
